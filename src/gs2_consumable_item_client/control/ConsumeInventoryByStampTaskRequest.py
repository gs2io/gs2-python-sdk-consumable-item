...
class ConsumeInventoryByStampTaskRequest(Gs2UserRequest):

    class Constant(Gs2ConsumableItem):
        FUNCTION = "ConsumeInventoryByStampTask"
    ...
    def __init__(self, params=None):
        ...
        """
        super(ConsumeInventoryByStampTaskRequest, self).__init__(params)
        if params is None:
            self.__task = None
    ...
    def with_task(self, task):
        ...
        :type task: unicode
        :return: this
        :rtype: ConsumeInventoryByStampTaskRequest
        """
        self.set_task(task)
        return self
