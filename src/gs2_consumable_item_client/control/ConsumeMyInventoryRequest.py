...
class ConsumeMyInventoryRequest(Gs2UserRequest):
    ...
    def set_item_pool_name(self, item_pool_name):
        ...
        """
        if _item_pool_name and not (isinstance(_item_pool_name, str) or isinstance(_item_pool_name, unicode)):
    ...
    def set_item_name(self, item_name):
        ...
        """
        if _item_name and not (isinstance(_item_name, str) or isinstance(_item_name, unicode)):
