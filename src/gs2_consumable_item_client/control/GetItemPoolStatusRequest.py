...
class GetItemPoolStatusRequest(Gs2BasicRequest):

    class Constant(Gs2ConsumableItem):
        FUNCTION = "GetItemPoolStatus"
    ...
    def __init__(self, params=None):
        ...
        """
        super(GetItemPoolStatusRequest, self).__init__(params)
        if params is None:
    ...
    def with_item_pool_name(self, item_pool_name):
        ...
        :type item_pool_name: unicode
        :return: this
        :rtype: GetItemPoolStatusRequest
        """
