...
class GetCurrentItemMasterRequest(Gs2BasicRequest):

    class Constant(Gs2ConsumableItem):
        FUNCTION = "GetCurrentItemMaster"
    ...
    def __init__(self, params=None):
        ...
        """
        super(GetCurrentItemMasterRequest, self).__init__(params)
        if params is None:
    ...
    def with_item_pool_name(self, item_pool_name):
        ...
        :type item_pool_name: unicode
        :return: this
        :rtype: GetCurrentItemMasterRequest
        """
